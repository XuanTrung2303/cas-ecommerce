        ...
        <section class="mt-6 grid grid-cols-1 md:grid-cols-5 gap-6">
                    ...
                    <div>
                        <div class="flex items-center justify-between">
                            <button type="button" onclick="applyFilter()"
                                class="bg-violet-600 rounded-md text-white uppercase text-center py-0.5 px-4">
                                Apply Filter</button>
                            <a href="{{ route('products') }}"><img
                                    src="{{ asset('dd4you/dpanel/images/reset-regular-24.png') }}" class="w-7 h-7"
                                    alt=""></a>
                        </div>
                    </div>
                </form>
            ...
            <div class="md:col-span-4 grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="md:col-span-2 flex items-center px-1.5 text-sm rounded border border-slate-300">
                    ...
                    <input type="search" id="search_input" placeholder="Search 1000+ Products" value="{{ request()->k }}"
                ...
                @empty
                    <div class="md:col-span-3 flex flex-col justify-center items-center gap-3">
                        <img src="dd4you/dpanel/images/page-not-found.png" alt="">
                        <h1 class="text-xl font-bold text-gray-800">Result Not Found!</h1>
